...
async function seed() {
  ...
  if (!productCount || Number(productCount.c) === 0) {
    ...
    const products = [
      ["Rainbow Cone", "Vanilla scoop with rainbow sprinkles.", 8000, "https://rainbowcone.com/wp-content/uploads/2025/06/rainbow_cone_original-1-1024x683.jpg", 30, catId("Cones")],
